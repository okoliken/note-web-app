...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-colors focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 tracking-[-0.2px] focus:shadow-neutral-400 focus:ring-2 focus:ring-white dark:focus:ring-base-700 dark:focus:shadow-base-800 transition-all transform hover:-translate-y-0.5 ease-in duration-300",
  {
    variants: {
      variant: {
        default:
